                                    ...
                                    <ul>
                                        ...
                                        <li class="has-dropdown"><a href="services.html">Services</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="services-details6.html">~ HISTOPATHOLOGY & CYTOLOGY</a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="header-cart-order d-flex align-items-center justify-content-end">
                                <div class="header-cart-list  d-flex align-items-center justify-content-end mr-50">
                                    ...
                                    <div class="tp-cart-icon-area ">
                                        ...
                                        <a class="login_icon_user"><i class="fa-solid fa-user"></i></a>
                                ...
                                <a class="header-bottom-btn" style="border-radius: 8px;"
                                    href="index.html#appointment ">Book
                                    Appointment</a>
                            </div>
                        </div>
    ...
    <div class="tpsideinfo tp-side-info-area">
        ...
        <div class="tpsideinfo__content mb-60">
            ...
            <div class="d-flex justify-content-evenly">
                ...
                <a href="./cart.html"><i style="font-size: 30px; color: white;"
                        class="fa-solid fa-cart-plus cart-icon"></i>
                </a>
                <a><i style="font-size: 30px; color: white;" class="fa-solid fa-user"></i></a>
            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget footer-col-3 mb-50 wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="footer-widget__info">
                                <ul>
                                    <li> <i class="fa-solid fa-location-dot"></i> &nbsp;<a href="#">#2-34-8/1,Chintavari
                                            Street
